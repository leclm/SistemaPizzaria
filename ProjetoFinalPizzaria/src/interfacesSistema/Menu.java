...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        FazerPedido.setBackground(new java.awt.Color(0, 153, 153));
        FazerPedido.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void FazerPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FazerPedidoActionPerformed
        if (janelaFazerPedido == null){
            janelaFazerPedido = new FazerPedido();
            janelaFazerPedido.setLocationRelativeTo(null);
            janelaFazerPedido.setVisible(true);
            janelaFazerPedido.setResizable(false);
        } else {
            janelaFazerPedido.setLocationRelativeTo(null);
            janelaFazerPedido.setVisible(true);
            janelaFazerPedido.setResizable(false);
