 ...
 * @author mathe
 */
public abstract class TesteForma {
    private boolean doisSabores;
    private double precocm;
    private double precoTotal;
    private double tamcm;
    private double tamcm2;
    private ArrayList<TesteSabor> sabor;

    public TesteForma(double precocm) {
        this.precocm = precocm;
    }
    
    public void setPizza(ArrayList<TesteSabor> sabor, double tamcm, double tamcm2){
        this.sabor = sabor;
        setTamcm(tamcm2);
        this.tamcm2 = tamcm2;
    ...
    public void setPizza(ArrayList<TesteSabor> sabor, double tamcm){
        this.sabor = sabor;
        this.tamcm = tamcm;
        setTamcm2(tamcm);
        doisSabores = sabor.size() == 2;
    ...
    public ArrayList<TesteSabor> getSabor() {
        return sabor;
    }
