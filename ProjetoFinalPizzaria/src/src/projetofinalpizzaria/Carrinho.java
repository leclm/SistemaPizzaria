...
public class Carrinho extends javax.swing.JFrame {
    ...
    private static ArrayList<Forma> pizzas = new ArrayList<>();
    private static int indexCliente;
    private Datastore dataStore = Datastore.getInstance();
    public Carrinho(int indexCliente) {
        initComponents();
        this.indexCliente = indexCliente;
        pizzas = dataStore.getClientes().get(this.indexCliente).getPedidoAberto().getPizzas();
        //pizzas = informaPizza;
        ...
        for (int cont=0;cont<pizzas.size();cont++){
            somaPreco += pizzas.get(cont).getPrecoTotal();
        }
    ...
    private void initComponents() {
        ...
        pizzaVerificada = new javax.swing.JLabel();
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(tamanhoCm, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(formato, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(pizzaVerificada, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(54, 54, 54))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(addPizza, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(sabor1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(sabor2)))
    ...
    private void recebePizzaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recebePizzaActionPerformed
        Forma pizzaAnalisada = pizzas.get(Integer.parseInt(recebePizza.getText())-1);
        pizzaVerificada.setText("Pizza "+recebePizza.getText());
        formato.setText(pizzaAnalisada.getFormato());
        tamanhoCm.setText(String.valueOf(pizzaAnalisada.getTamcm()));
        tamanhoCm2.setText(String.valueOf(pizzaAnalisada.getTamcm2()));
        if (pizzaAnalisada.getDoisSabores()){
            numSabores.setText("2 Sabores");
            sabor1.setText(pizzaAnalisada.getSabor().get(0).getNome());
            sabor2.setText(pizzaAnalisada.getSabor().get(1).getNome());
        }
        else{
            numSabores.setText("1 Sabor");
            sabor1.setText(pizzaAnalisada.getSabor().get(0).getNome());
        }
        preco.setText(String.valueOf(pizzaAnalisada.getPrecoTotal()));
    ...
    private void alterarPizzaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarPizzaActionPerformed
        if ("aberto".equalsIgnoreCase(status)){
            ...
            dataStore.getClientes().get(indexCliente).getPedidoAberto().getPizzas().remove(Integer.parseInt(recebePizza.getText())-1);
            this.setVisible(false);
            FazerPedido fazerPedido = new FazerPedido(indexCliente);
    ...
    private void botaoEntregueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntregueActionPerformed
        status = "Entregue";
        dataStore.getClientes().get(indexCliente).getPedidoAberto().setStatus(status);
        this.setVisible(false);
        formato.setText("Formato");
        tamanhoCm.setText("TamanhoCm");
        tamanhoCm2.setText("TamanhoCm2");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Carrinho(indexCliente).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel pizzaVerificada;
