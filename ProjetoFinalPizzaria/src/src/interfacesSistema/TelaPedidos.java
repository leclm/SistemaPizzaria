...
public class TelaPedidos extends javax.swing.JFrame {
    ...
    private void atualizaTabela(){
        ...
        ArrayList<ListaPedidos> lista = new ArrayList();
        datastore.getClientes().forEach(cliente -> {
            cliente.getPedidos().forEach(pedido -> {
                ListaPedidos novoPedido = new ListaPedidos(cliente.getId(),cliente.getNome(),pedido.getId(),pedido.getStatus());
            });
        });
    }
